  ...
  return (
    ...
    <h1 className='text-4xl text-white font-bold'>URL Shortener</h1>
      ...
      <div className='mt-8 flex items-center justify-center'>
        ...
        <button onClick={() => handleShorten(url)} className={`bg-blue-500 text-white p-3 pl-10 pr-10 rounded-r-lg hover:bg-blue-600 border-1 border-blue-500 cursor-pointer ${loading ? 'opacity-50 hover:bg-gray-600  border-gray-600  cursor-not-allowed' : 'hover:bg-blue-600 border-1 border-blue-500 opacity-100 cursor-pointer'}`}> {shortenedLink ? 'Copy'   :  'Short'}</button>
